...
<body>
    ...
    <div class="card-header-custom">
        <h3 class="card-title"><i class="fas fa-lock me-2"></i> Change Password</h3>
    </div>
@include('handler')
    ...
    <div class="alert alert-info mt-4" style="border-radius: 10px;">
        ...
        <small>Ensure your new password is at least 6 characters long and different from your old one.</small>
    </div>
</div>
